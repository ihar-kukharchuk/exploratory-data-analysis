...
# DateTime ~ Voltage graph
with(hpc_data, plot(x = datetime, y = Voltage, type = "l"))
...
# DateTime ~ Global Reactive Power graph
with(hpc_data, plot(x = datetime, y = Global_reactive_power, type = "l"))
